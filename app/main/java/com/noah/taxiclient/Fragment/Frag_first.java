...
import com.noah.taxiclient.Activity.Act_arrive;
import com.noah.taxiclient.Activity.Act_loding_matching;
 ...
 */
public class Frag_first extends Fragment implements OnMapReadyCallback,
    ...
    *          프래그먼트 객체
    * #####################################*/
    public static Frag_first newInstance() {
        Bundle args = new Bundle();

        Frag_first frag_first = new Frag_first();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_frag_first, container, false);
        ...
        LocalDB = getActivity().getSharedPreferences(LocalDBname, 0);
            ...
            public void handleMessage(Message msg) {
                ...
                switch (msg.arg1) {
                    ...
                    case 1:
                        ...
                        startActivity(new Intent(getActivity(), Act_loding_matching.class));
                }
            }
        }
        ...
        arrive.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(getActivity(), Act_arrive.class);
        ...
        call.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(canCallTaxi){
                    ...
                    SharedPreferences sp = getActivity().getSharedPreferences("lang", getActivity().MODE_PRIVATE);
                    ...
                    Network.push(send, getActivity(), handler); //모든 택시에게 콜 메시지를 보낸다.ㅣ


                }else{
                    Toast.makeText(getActivity(), "목적지를 설정해주세요.", Toast.LENGTH_SHORT).show();
                }
...
//            push(uName); //모든 택시에게 콜 메시지를 보낸다.ㅣ
                ...
                if (checkGPSService()) {
                    if (latitude != 0 && longitude != 0) {
                        ...
                        if (myAdress != null) {
                            ...
                            Toast.makeText(getActivity(), "내위치를 다시 갱신해주세요.", Toast.LENGTH_SHORT).show();
                        }
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        Log.v("##Frag_first", "화면" + isVisibleToUser);
        if (!isVisibleToUser) {
            //지도 나타내기
...
//        mapFragment = (SupportMapFragment) getFragmentManager().findFragmentById(R.id.first_map);
        ...
        getChildFragmentManager().beginTransaction().add(R.id.first_map, mapFragment).commit();
        mapFragment.getMapAsync(Frag_first.this);


        if (mGoogleApiClient == null) {
            mGoogleApiClient = new GoogleApiClient.Builder(getActivity())
                    .addConnectionCallbacks(Frag_first.this)
                    .addOnConnectionFailedListener(Frag_first.this)
...
//        }
    ...
    public void onConnected(@Nullable Bundle bundle) {
        ...
        if (ActivityCompat.checkSelfPermission(getActivity(), Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(getActivity(), Manifest.permission.ACCESS_COARSE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
            Log.v("##위치요청", "정보요청!!!");
            //위치정보 요청
            LocationServices.FusedLocationApi.requestLocationUpdates(mGoogleApiClient, mLocationRequest, Frag_first.this);
    ...
    private void push(final String send) {
        class checkEmail extends AsyncTask<String, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(getActivity(), "Please Wait", null, true, true); //서버접속하기 전에 로딩 띄우기
