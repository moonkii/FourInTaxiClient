...
public class MySQLiteOpenHelper_Food extends SQLiteOpenHelper {

    public MySQLiteOpenHelper_Food(Context context, String name, SQLiteDatabase.CursorFactory factory, int version) {
        super(context, name, factory, version);
    }

    @Override
    public void onCreate(SQLiteDatabase db) {
        String sql= "CREATE TABLE Food (content_id TEXT PRIMARY KEY,type TEXT,classification TEXT,area TEXT,korean TEXT,english TEXT,chinese TEXT,japanese TEXT,french TEXT);";
        db.execSQL(sql);
    }
    ...
    public void insert(String type,String classification,String area,String content_id,String korean, String english, String chinese, String japanese,String french) {
        ...
        Act_Splash.db = Act_Splash.helper_F.getWritableDatabase(); // db 객체를 얻어온다. 쓰기 가능
        ...
        Act_Splash.db.execSQL("INSERT OR REPLACE INTO Food (type,classification,area,content_id,korean,english,chinese,japanese,french) VALUES ('"  + type + "','" + classification + "','" +area+ "','" +content_id +"','" +korean + "','" + english + "','" + chinese + "','" + japanese+ "','" + french+ "')");
    ...
    public  ArrayList<String> select(int language_num) throws JSONException {
        ...
        Act_Splash.db = Act_Splash.helper_F.getReadableDatabase(); // db객체를 얻어온다. 읽기 전용

        Cursor c = Act_Splash.db.query("Food",null,null,null,null,null,null,null);
        ...
        while (c.moveToNext()) {
            ...
            //Act_Splash.db.rawQuery("SELECT * FROM Food", null);
            //System.out.println("type : "+type+", classification : "+classification+", area : " + area +", content_id : " + content_id + ", korean : " + korean + ", english : " + english + ", chinese : " + chinese+", japanese : "+japanese+", french : "+french);
        }
    ...
    public String select_area(int language_num, String areas) {
        ...
        Act_Splash.helper_F.getReadableDatabase(); // db객체를 얻어온다. 읽기 전용

        Cursor c = Act_Splash.db.rawQuery("SELECT * FROM Food WHERE area='"+areas+"';", null);
    ...
    public String select_content_id(int language_num, String id) {
        ...
        Cursor c = Act_Splash.db.rawQuery("SELECT * FROM Food WHERE content_id='"+id+"';", null);
